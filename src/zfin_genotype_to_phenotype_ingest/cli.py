"""Command line interface for zfin-genotype-to-phenotype-ingest."""
...
def callback(
    ...
    """zfin-genotype-to-phenotype-ingest CLI."""
    if version:
        from zfin_genotype_to_phenotype_ingest import __version__

        typer.echo(f"zfin-genotype-to-phenotype-ingest version: {__version__}")
        raise typer.Exit()


@app.command()
def download(force: bool = typer.Option(False, help="Force download of data, even if it exists")):
    """Download data for zfin-genotype-to-phenotype-ingest."""
    typer.echo("Downloading data for zfin-genotype-to-phenotype-ingest...")
...
def transform(
    ...
    """Run the Koza transform for zfin-genotype-to-phenotype-ingest."""
    typer.echo("Transforming data for zfin-genotype-to-phenotype-ingest...")
